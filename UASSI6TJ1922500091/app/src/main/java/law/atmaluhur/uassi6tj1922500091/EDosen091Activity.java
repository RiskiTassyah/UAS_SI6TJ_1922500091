...
public class EDosen091Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edosen091);
        btn_kembali = findViewById(R.id.btn_kembali);
        btn_kembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(EDosen091Activity.this, MainActivity.class);
                startActivity(i);
            }
        });
        ...
        class tambahdosen extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                ...
                load = ProgressDialog.show(
                        EDosen091Activity.this,"Add ...","Wait..",false,false
                );
            }
            ...
            protected String doInBackground(Void... v) {
                ...
                String res = rh.sendPostRequest("http://192.168.43.245/API/tambah_dosen.php/", params);
                return res;
            }
            ...
            protected void onPostExecute(String s) {
                ...
                load.dismiss();
                Toast.makeText(EDosen091Activity.this, s,Toast.LENGTH_LONG).show();
            }
        }
